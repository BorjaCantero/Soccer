...
%
%[testImage, testLabel] = readMNIST("train-images.idx3-ubyte", "train-labels.idx1-ubyte", 12000, 0);
%[mostraImage, mostraLabel] = readMNIST("train-images.idx3-ubyte", "train-labels.idx1-ubyte", 48000, 12000);
Dades = regionprops(testImage,'centroid','area','MajorAxisLength','MinorAxisLength', 'Circularity', 'BoundingBox');
T = table('Size',[12000 6],'VariableTypes',{'double','double','cell', 'cell', 'cell', 'cell'}, 'VariableNames', {'a','b','c','d','e','f'});

for i = 1:12000
    [L, n] = bwlabel(testImage(:,:,i));
    o = regionprops(L,'centroid','area','MajorAxisLength','MinorAxisLength', 'Circularity', 'BoundingBox');
    T(i).a =  o.Area;
end
